...
@interface NameSearchResponseRoot : GPBRootObject
@end

#pragma mark - NameSearchResponse

typedef GPB_ENUM(NameSearchResponse_FieldNumber) {
  NameSearchResponse_FieldNumber_NamesArray = 1,
};

@interface NameSearchResponse : GPBMessage
